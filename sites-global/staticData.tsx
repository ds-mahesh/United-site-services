export const StaticData = {
  ...
  Meta_description:
    "Visit Matalan Demo Store | Matalan is your local great value family retailer shop. Find latest seasonal looks for Women, Men and kids, plus a huge range of homeware.",
  locator_breadcrumb: "Store Locator",
  FindLocationtext: "Find a Branch Near You",
  Usemylocation: "Use my location",
  Search: "Search",
  Brandname: "United Site Services",
  miles: "miles",
  tempClosed: "Temporarily Closed",
  StoreDetailbtn: "Branch Details",
