...
export const config: TemplateConfig = {
  stream: {
    ...
    fields: ["name", "c_getQuote", "c_locatorbanner"],
...
export const getHeadConfig: GetHeadConfig<TemplateRenderProps> = ({
  ...
  return {
    title: `${
      document.c_meta_title ? document.c_meta_title : `United Site Services`
    }`,
    charset: "UTF-8",
        ...
        attributes: {
          ...
          content: `${
            document.c_meta_description
              ? document.c_meta_description
              : `View  United Site Services near you today at USS.`
          }`,
        },
      },
        ...
        attributes: {
          ...
          content: `${
            document.c_meta_title
              ? document.c_meta_title
              : `United Site Services Near Me - Find United Site Services Branch Locator Here.`
          }`,
        },
      },
      {
...
const Locator: Template<TemplateRenderProps> = ({ document, __meta }) => {
  const { _site, c_getQuote, c_locatorbanner } = document;
